...
**Сервер:** Ubuntu 22.04 / 24.04 LTS. **Локальная машина — любая:** Linux, macOS или Windows
(на Windows отличается только копирование SSH-ключа — через WSL или PowerShell, описано в скилле).
